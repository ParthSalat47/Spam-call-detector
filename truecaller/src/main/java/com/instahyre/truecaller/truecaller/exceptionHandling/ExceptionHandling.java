package com.instahyre.truecaller.truecaller.exceptionHandling;
...
public class ExceptionHandling extends ResponseEntityExceptionHandler{
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(
			MissingServletRequestParameterException exceptionObject, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
